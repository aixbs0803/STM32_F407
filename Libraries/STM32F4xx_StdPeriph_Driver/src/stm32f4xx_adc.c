...
/**
  ...
  * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.//选择ADC型号，ADC1、ADC2、ADC3
  * @param  ADC_Channel: the ADC channel to configure. //选择ADC通道
  *          This parameter can be one of the following values:
  *            @arg ADC_Channel_0: ADC Channel0 selected
  *            @arg ADC_Channel_1: ADC Channel1 selected
  *            @arg ADC_Channel_2: ADC Channel2 selected
  ...
  *            @arg ADC_Channel_17: ADC Channel17 selected
  *            @arg ADC_Channel_18: ADC Channel18 selected                       
  * @param  Rank: The rank in the regular group sequencer..//这是在16个通道中的排名
  *          This parameter must be between 1 to 16.
  * @param  ADC_SampleTime: The sample time value to be set for the selected channel. 
  *          This parameter can be one of the following values://采样时间3个周期-480个周期
