...
typedef struct
{
  uint16_t SPI_Direction;           /*!< 指定SPI单向或双向数据模式。
                                         此参数可以是 @ref SPI_data_direction 的值 */

  uint16_t SPI_Mode;                /*!< 指定SPI工作模式。
                                         此参数可以是 @ref SPI_mode 的值 */

  uint16_t SPI_DataSize;            /*!< 指定SPI数据大小。
                                         此参数可以是 @ref SPI_data_size 的值 */

  uint16_t SPI_CPOL;                /*!< 指定串行时钟稳态。
                                         此参数可以是 @ref SPI_Clock_Polarity 的值 */

  uint16_t SPI_CPHA;                /*!< 指定位捕获的时钟活动边沿。
                                         此参数可以是 @ref SPI_Clock_Phase 的值 */

  uint16_t SPI_NSS;                 /*!< 指定NSS信号是由
                                         硬件(NSS引脚)还是由SSI位的软件管理。
                                         此参数可以是 @ref SPI_Slave_Select_management 的值 */
 
  uint16_t SPI_BaudRatePrescaler;   /*!< 指定用于配置发送和接收SCK时钟的
                                         波特率预分频值。
                                         此参数可以是 @ref SPI_BaudRate_Prescaler 的值
                                         @note 通信时钟源自主时钟。
                                               从时钟无需设置。 */

  uint16_t SPI_FirstBit;            /*!< 指定数据传输是从MSB还是LSB位开始。
                                         此参数可以是 @ref SPI_MSB_LSB_transmission 的值 */
...
typedef struct
{
  ...
  uint16_t I2S_Mode;         /*!< 指定I2S工作模式。
                                  此参数可以是 @ref I2S_Mode 的值 */

  uint16_t I2S_Standard;     /*!< 指定用于I2S通信的标准。
                                  此参数可以是 @ref I2S_Standard 的值 */

  uint16_t I2S_DataFormat;   /*!< 指定I2S通信的数据格式。
                                  此参数可以是 @ref I2S_Data_Format 的值 */

  uint16_t I2S_MCLKOutput;   /*!< 指定I2S MCLK输出是否启用。
                                  此参数可以是 @ref I2S_MCLK_Output 的值 */

  uint32_t I2S_AudioFreq;    /*!< 指定为I2S通信选择的频率。
                                  此参数可以是 @ref I2S_Audio_Frequency 的值 */

  uint16_t I2S_CPOL;         /*!< 指定I2S时钟的空闲状态。
                                  此参数可以是 @ref I2S_Clock_Polarity 的值 */
}I2S_InitTypeDef;
